...
app.get('/oauth2/login', (req, res) => {
    const authUrl = oauth.generateAuthUrl({
        ...
        redirectUri: 'https://discord.com/oauth2/authorize?client_id=1389852325648007290&response_type=code&redirect_uri=https%3A%2F%2Fblake0v2.github.io%2FTheArchAngels%2Fdashboard.html&scope=identify', // Match this with your Discord redirect URI
    });
